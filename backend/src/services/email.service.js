...
exports.sendBookingStatusUpdateEmail = exports.sendBookingStatusUpdateEmailToCustomer = exports.sendBookingCancellationEmail = exports.sendBookingConfirmationEmail = void 0;
...
const generateBookingConfirmationEmailVN = (userName, cafeName, bookingDate, bookingTime, numberOfPeople, address, cafePhone, bookingId) => {
...
const generateBookingConfirmationEmailJP = (userName, cafeName, bookingDate, bookingTime, numberOfPeople, address, cafePhone, bookingId) => {
...
const sendBookingConfirmationEmail = async (userEmail, userName, cafeName, bookingDate, bookingTime, numberOfPeople, address, cafePhone, bookingId, language = 'vi') => {
    try {
        if (!userEmail) {
...
const sendBookingCancellationEmail = async (userEmail, userName, cafeName, bookingId, language = 'vi') => {
    try {
        if (!userEmail) {
            console.error('User email is required');
            return false;
...
const sendBookingStatusUpdateEmailToCustomer = async (userEmail, userName, cafeName, bookingDate, bookingTime, numberOfPeople, status, bookingId, language = 'vi') => {
    try {
        if (!userEmail) {
            console.error('User email is required');
            return false;
...
exports.sendBookingStatusUpdateEmailToCustomer = sendBookingStatusUpdateEmailToCustomer;
// Send booking status update email (for cafe owner)
const sendBookingStatusUpdateEmail = async (ownerEmail, ownerName, customerName, cafeName, bookingDate, bookingTime, numberOfPeople, status, language = 'vi') => {
    try {
        if (!ownerEmail) {
