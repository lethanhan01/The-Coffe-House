...
router.post('/', auth_middleware_1.authenticateToken, reviewController.createReviewHandler);
// Phải đăng nhập mới được report đánh giá
router.post('/report', auth_middleware_1.authenticateToken, reviewController.createReviewReport);
