...
const cafeController = __importStar(require("../controllers/cafe.controller"));
...
router.post('/:id/request-deletion', auth_middleware_1.authenticateToken, cafeController.requestCafeDeletion);
router.put('/:id', cafeController.updateCafe);
router.delete('/:id', cafeController.deleteCafe);
exports.default = router;
//# sourceMappingURL=cafe.routes.js.map